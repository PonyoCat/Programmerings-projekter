# Info
Dropshipping.zip:
A project using SQL databases for saving, using and sorting data.

EksamensprojektForbedring3.zip:
...
Because they are processing applications made to be run locally you need to
1. Download the zip file
2. Unpack zip file
3. Run processing file (.pde)
